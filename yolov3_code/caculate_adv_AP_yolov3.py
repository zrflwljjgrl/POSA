...
if __name__ == "__main__":
    ...
    train_dir = os.path.join(dataset_dir, 'cross_modal_patch_attack', 'yolov3_image/empatch-y2')  #gai
    # 获取文件夹中的所有图片路径
    ...
    # 创建保存对抗样本检测结果的目录
    output_dir = "../new_labels/yolov3/empatch-y2/detection-results_06/adv_sample"  #gai
    # 创建目录（如果不存在）
