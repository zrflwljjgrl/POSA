...
from DE_inria_v3 import DifferentialEvolutionAlgorithm
...
if __name__ == "__main__":
    ...
    # 读取行人数据集
    dataset_dir = '../inria'  # 替换为你的数据集路径
    final_dir = '../workspace/cross_modal_patch_attack/yolov3_image/yinshenyi/final'  #不同的补丁保存不同的路径（改）
    change_dir = '../workspace/cross_modal_patch_attack/yolov3_image/yinshenyi/final'
    ...
    for img_path in pos_image_paths:
        ...
        for i in range(L):
            ...
            dea = DifferentialEvolutionAlgorithm(15, 24, points_index, eq_points, [px, py],
                                                 ...
                                                 ori_squre_confidence,rg,r2,r1) #传入的模型要改
