...
tmp_dir_vis = '../workspace/cross_modal_patch_attack/yolov2_image/yolo-result/tmp_dir_visible'
mask_dir = '../workspace/cross_modal_patch_attack/yolov2_image/yolo-result/mask'
final_dir = '../workspace/cross_modal_patch_attack/yolov2_image/yolo-result/final'
# 创建目录（如果不存在）
