...
from DE_inria_v2 import DifferentialEvolutionAlgorithm
...
if __name__ == "__main__":
    ...
    final_dir = '../workspace/cross_modal_patch_attack/yolov2_image/yolo-result/final'  #不同的补丁保存不同的路径（改）
    change_dir = '../workspace/cross_modal_patch_attack/yolov2_image/yolo-result/final'
