...
from DE_inria_v2_xiaorong import DifferentialEvolutionAlgorithm
...
if __name__ == "__main__":
    ...
    final_dir = '../../xiaorong_labels/yolov2/object_score/final'  #不同的补丁保存不同的路径（改）
