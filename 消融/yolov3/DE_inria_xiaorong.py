...
tmp_dir_vis = '../../xiaorong_labels/yolov3/yinshenyi/tmp_dir_visible'
mask_dir = '../../xiaorong_labels/yolov3/yinshenyi/mask'
final_dir = '../../xiaorong_labels/yolov3/yinshenyi/final'
# 创建目录（如果不存在）
...
class DifferentialEvolutionAlgorithm:
    ...
    def crossoverOperation(self, i, vi, r2):  # 实现交叉操作
        ...
        for u in range(0,len_vi):
            ...
            y_low, y_high, x_left, x_right = self.region[u][0], self.region[u][1], self.region[u][2], self.region[u][3]  # 补丁变形范围限制
            ...
            for j in range(0, int(self.vardim)):  # 第一个补丁
                if j % 2 == 0:
                    ...
                    if (pick < self.params[0] or j == k) and (
                            ifcross(self.eq_points[u][j // 2], self.eq_points[u][j // 2 + 1], [vi[u][j], vi[u][j + 1]], px_1,
                                    py_1) == False \
